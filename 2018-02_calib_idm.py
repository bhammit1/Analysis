...
from tools.functions_idm import run_idm_GA
from tools.functions_idm import initiate_201802Calib_idm_summary_file
from tools.functions_idm import append_to_201802Calib_idm_summary_file


# Save Scheme:
# ----------------------------------------------------------------------------------------
date = '2018-02-15_idm'  # Naming for output files - Cannot be with dots - must be with dashes

# Identify Paths:
# ----------------------------------------------------------------------------------------
trip_id_input_path = r'C:\Users\britton.hammit\Dropbox\00-Education\research\03-NDS_and_RID\WY_SHRP2_NDS\Python_Analysis\07-Results\2018.02.15 IdmCalibration\Global_Inputs'
...
driver_survey_input_path = r'C:\Users\britton.hammit\Dropbox\00-Education\research\03-NDS_and_RID\WY_SHRP2_NDS\Python_Analysis\07-Results\2018.02.15 IdmCalibration\Global_Inputs'
save_path = r'C:\Users\britton.hammit\Dropbox\00-Education\research\03-NDS_and_RID\WY_SHRP2_NDS\Python_Analysis\07-Results\2018.02.15 IdmCalibration\Results'
...
# ----------------------------------------------------------------------------------------
cxpb, mutpb, m_indpb, ngen, npop = 0.7, 0.3, 0.5, 60, 800
...
initiate_201802Calib_idm_summary_file(summary_file)
...
for iterator in range(len(trip_no_list)):
    ...
    calib_score, calib_best_indiv = run_idm_GA(cf_collections=cf_collections, cxpb=cxpb, mutpb=mutpb,
    ...
    append_to_201802Calib_idm_summary_file(file=summary_file,
                                              trip_no=trip_no_this,
                                              driver_id=driver_id,
