...
from tools.functions_newell import initiate_201802Calib_newell_summary_file
from tools.functions_newell import append_to_201802Calib_newell_summary_file


# Save Scheme:
# ----------------------------------------------------------------------------------------
date = '2018-02-15_newell'  # Naming for output files - Cannot be with dots - must be with dashes

# Identify Paths:
# ----------------------------------------------------------------------------------------
trip_id_input_path = r'C:\Users\britton.hammit\Dropbox\00-Education\research\03-NDS_and_RID\WY_SHRP2_NDS\Python_Analysis\07-Results\2018.02.15 NewellCalibration\Global_Inputs'
...
save_path = r'C:\Users\britton.hammit\Dropbox\00-Education\research\03-NDS_and_RID\WY_SHRP2_NDS\Python_Analysis\07-Results\2018.02.15 NewellCalibration\Results'
...
initiate_201802Calib_newell_summary_file(summary_file)
...
for iterator in range(len(trip_no_list)):
    ...
    calib_score, calib_best_indiv = run_newell_GA(cf_collections=cf_collections, cxpb=cxpb, mutpb=mutpb,
    ...
    append_to_201802Calib_newell_summary_file(file=summary_file,
                                              trip_no=trip_no_this,
                                              driver_id=driver_id,
