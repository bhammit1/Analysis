...
# Save Scheme:
# ----------------------------------------------------------------------------------------
date = '2018-03-08_idmTEST'  # Naming for output files - Cannot be with dots - must be with dashes
...
for trip_nos_filename in trip_nos_filename_list:
    ...
    calib_score, calib_best_indiv = run_idm_GA(cf_collections=cf_collections_all, cxpb=cxpb, mutpb=mutpb,
